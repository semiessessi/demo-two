...
export function createEnemyManager(scene, chigKit, projectiles, opts = {}) {
  ...
  function tryFire(e, player, aiming) {
    ...
    projectiles.spawn({ pos: muzzle, vel: evel, color: 0xffffff, team: 'enemy', damage: params.pulseDamage, life: 2.6, radius: 0.7, scale: 1.35, width: 2, glow: 2.8, noise: 0.6, round: 1 }); // round fractal-noise streak
