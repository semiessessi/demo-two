...
// before anyone else does. It's a trap of sorts: the Chigs want the core too, and for the first time the
// Longshots meet the SILICATES (the Chigs' rebel-AI collaborators), who were here first. Hold the wreck
// through the ambush while the core downloads, then run it home. This opens the AeroTech conspiracy thread.
//
...
export const m3 = {
  ...
  script: [
    ...
    // first Silicate contact — cold transmission + a heavier wave they're leading
  ...
  lines: {
    ...
    'silicate.taunt':   { speaker: 'silicate',  text: "Longshot flight. We were here first; the Cassandra's secrets are spoken for. Call it — heads, you turn back; tails, you burn. We always win the toss.", dur: 8.5 },
    'boxcars.what':     { speaker: 'boxcars',   text: "The hell was that? That weren't no Chig on the comms...", dur: 3.5 },
    'house.silicate':   { speaker: 'house',     text: "Silicates. The Chigs' pet machines. If they want this core too, that's all the more reason we leave with it. Hold the line.", dur: 6.5 },
    'house.core':       { speaker: 'house',     text: "Core's almost across — keep them off the Cassandra, just a little longer.", dur: 4.5 },
    'house.gotit':      { speaker: 'house',     text: "Got it — core's aboard. Two different enemies came to keep this buried; that tells me it's worth carrying. We're taking it home. Form up, back to the gate.", dur: 8.5 },
